...
export class Locator<U> {
    ...
    at<K extends keyof U>(propertyName: K): Locator<U[K]> {
        return new Locator(
            this._obj ? (this._obj instanceof Map ? this._obj.get(propertyName) : this._obj[propertyName]) : undefined,
            this,
            propertyName,
        );
    }
 ...
 * @public
 */
export function locator<U extends Map<string | symbol | number, unknown>>(obj: U): Locator<any>;
