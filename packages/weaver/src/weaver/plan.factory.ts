...
import { AdviceType, Advice, PointcutPhase, CompileAdvice } from '@aspectjs/core';
...
import { _getWeaverContext } from './weaver-context';
...
export class _AdviceExecutionPlanFactory {
    create<T, A extends AdviceType = any>(
        ...
        const compileFn = (ctxt: MutableAdviceContext<T, A>) => {
            ...
            )[PointcutPhase.COMPILE] as CompileAdvice<T, A>[];
            hooks.preCompile?.call(hooks, ctxt, compileAdvices);
