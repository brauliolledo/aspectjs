 ...
 * @public
 */
export declare type AdviceContext<T = unknown, A extends AdviceType = any> = AfterContext<T, A> | BeforeContext<T, A> | AfterReturnContext<T, A> | AfterThrowContext<T, A> | AroundContext<T, A> | CompileContext<T, A>;
/**
 * @public
 */
export { AfterContext, BeforeContext, AfterReturnContext, AfterThrowContext, AroundContext, CompileContext };
//# sourceMappingURL=advice.context.type.d.ts.map