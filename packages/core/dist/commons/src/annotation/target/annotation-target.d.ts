...
export interface AnnotationTarget<T = unknown, A extends AdviceType = AdviceType> {
    ...
    readonly parent: A extends AdviceType.METHOD ? AnnotationTarget<any, AdviceType.CLASS> : A extends AdviceType.PROPERTY ? AnnotationTarget<any, AdviceType.CLASS> : A extends AdviceType.PARAMETER ? AnnotationTarget<any, AdviceType.METHOD> : ClassAdviceTarget<any>;
 ...
 * @public
 */
export declare type AdviceTarget<T = unknown, A extends AdviceType = any> = AnnotationTarget<T, A>;
/**
 * @public
 */
...
//# sourceMappingURL=annotation-target.d.ts.map