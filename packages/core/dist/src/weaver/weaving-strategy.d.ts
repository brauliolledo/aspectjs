import { AdviceType, AfterAdvice, AfterReturnAdvice, AfterThrowAdvice, AroundAdvice, BeforeAdvice, CompileAdvice, MutableAdviceContext, JoinPoint } from '@aspectjs/core/commons';
/**
 * @internal
 */
...
//# sourceMappingURL=weaving-strategy.d.ts.map