...
import { _getReferenceConstructor, _setReferenceConstructor, assert, isUndefined } from '@aspectjs/core/utils';
import { _defineFunctionProperties } from '../../utils';
import { _GenericWeavingStrategy } from './generic-weaving-strategy';
/**
 * @internal
 */
export class _ClassWeavingStrategy extends _GenericWeavingStrategy {
