import { Annotation, AnnotationRef, AnnotationType, PropertyAnnotation } from '@aspectjs/common';
...
export class PropertyAnnotationPointcutExpressionBuilder {
    readonly setter = new AnnotationPointcutExpressionBuilder('property#set');
...
export interface PointcutExpressionBuilder {
    readonly class: AnnotationPointcutExpressionBuilder;
    readonly property: PropertyAnnotationPointcutExpressionBuilder;
    readonly method: AnnotationPointcutExpressionBuilder;
    readonly parameter: AnnotationPointcutExpressionBuilder;
}
